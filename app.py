...
model = pk.load(open('D:/project/Used Phone Price/Used-Phone-Price-Prediction-Project-main/Used-Phone-Price-Prediction-Project-main/Price_Predictor.pkl','rb')) 
scaler = pk.load(open('D:/project/Used Phone Price/Used-Phone-Price-Prediction-Project-main/Used-Phone-Price-Prediction-Project-main/Scaler.pkl','rb'))
